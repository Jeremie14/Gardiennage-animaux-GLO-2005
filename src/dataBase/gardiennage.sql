...
-- continuation pattern jusqu’à U0100
...
-- CHATS (20)
('A0021','Minou','chat','Siamois',3,4,'U0001'),
('A0022','Chanel','chat','Maine Coon',5,7,'U0002'),
('A0023','Felix','chat','Bengal',2,5,'U0003'),
('A0024','Lili','chat','Persan',4,6,'U0004'),
('A0025','Moka','chat','Sphynx',3,4,'U0005'),
('A0026','Neko','chat','Siamois',1,3,'U0006'),
('A0027','Shadow','chat','Maine Coon',6,8,'U0007'),
('A0028','BellaCat','chat','Bengal',2,5,'U0008'),
('A0029','Cleo','chat','Persan',5,6,'U0009'),
('A0030','Zara','chat','Sphynx',4,4,'U0010'),
('A0031','Oreo','chat','Siamois',3,4,'U0011'),
('A0032','LunaCat','chat','Maine Coon',2,7,'U0012'),
('A0033','Misty','chat','Bengal',4,5,'U0013'),
('A0034','Snow','chat','Persan',6,6,'U0014'),
('A0035','Pixel','chat','Sphynx',1,3,'U0015'),
('A0036','Jazz','chat','Siamois',5,4,'U0016'),
('A0037','Tigrou','chat','Bengal',3,5,'U0017'),
('A0038','Mia','chat','Maine Coon',4,7,'U0018'),
('A0039','Fiona','chat','Persan',2,6,'U0019'),
('A0040','Neo','chat','Sphynx',3,4,'U0020'),

-- LAPINS (15)
('A0041','Biscuit','lapin','Nain',2,2,'U0001'),
('A0042','Fluffy','lapin','Bélier',3,3,'U0002'),
('A0043','Caramel','lapin','Nain',1,2,'U0003'),
('A0044','Pompom','lapin','Bélier',4,4,'U0004'),
('A0045','Snowy','lapin','Nain',2,1,'U0005'),
('A0046','Coco','lapin','Nain',3,2,'U0006'),
('A0047','Moka','lapin','Bélier',5,4,'U0007'),
('A0048','Litchi','lapin','Nain',1,2,'U0008'),
('A0049','Noisette','lapin','Bélier',2,3,'U0009'),
('A0050','Plume','lapin','Nain',3,2,'U0010'),
('A0051','Bunny','lapin','Nain',2,2,'U0011'),
('A0052','Roux','lapin','Bélier',4,4,'U0012'),
('A0053','Velours','lapin','Nain',1,1,'U0013'),
('A0054','Câlin','lapin','Bélier',3,3,'U0014'),
('A0055','Chouchou','lapin','Nain',2,2,'U0015'),

-- OISEAUX (15)
('A0056','Kiwi','oiseau','Perroquet',3,1,'U0001'),
('A0057','Rio','oiseau','Cacatoès',4,1,'U0002'),
('A0058','Sky','oiseau','Perruche',2,0,'U0003'),
('A0059','Zazu','oiseau','Ara',5,2,'U0004'),
('A0060','CocoBird','oiseau','Cacatoès',6,1,'U0005'),
('A0061','Blue','oiseau','Perruche',3,0,'U0006'),
('A0062','Sunny','oiseau','Ara',4,2,'U0007'),
('A0063','Mango','oiseau','Cacatoès',5,1,'U0008'),
('A0064','Pepper','oiseau','Perruche',2,0,'U0009'),
('A0065','Flappy','oiseau','Ara',3,2,'U0010'),
('A0066','Chico','oiseau','Cacatoès',4,1,'U0011'),
('A0067','Loco','oiseau','Perruche',3,0,'U0012'),
('A0068','RioBird','oiseau','Ara',5,2,'U0013'),
('A0069','Jazz','oiseau','Cacatoès',6,1,'U0014'),
('A0070','Tico','oiseau','Perruche',2,0,'U0015'),

-- FURETS (10)
('A0071','Fury','furet','Angora',2,2,'U0001'),
('A0072','Nox','furet','Standard',3,1,'U0002'),
('A0073','LokiF','furet','Angora',4,2,'U0003'),
('A0074','ShadowF','furet','Standard',2,1,'U0004'),
('A0075','MistyF','furet','Angora',3,2,'U0005'),
('A0076','Bolt','furet','Standard',1,1,'U0006'),
('A0077','Ziggy','furet','Angora',2,2,'U0007'),
('A0078','NovaF','furet','Standard',3,1,'U0008'),
('A0079','Flash','furet','Angora',4,2,'U0009'),
('A0080','Pix','furet','Standard',2,1,'U0010'),

-- HAMSTERS (10)
('A0081','Chips','hamster','Syrien',1,0,'U0001'),
('A0082','BiscuitH','hamster','Russe',1,0,'U0002'),
('A0083','CocoH','hamster','Syrien',2,0,'U0003'),
('A0084','Nugget','hamster','Russe',1,0,'U0004'),
('A0085','MimiH','hamster','Syrien',1,0,'U0005'),
('A0086','FluffyH','hamster','Russe',2,0,'U0006'),
('A0087','Pip','hamster','Syrien',1,0,'U0007'),
('A0088','SnowH','hamster','Russe',1,0,'U0008'),
('A0089','Tiny','hamster','Syrien',2,0,'U0009'),
('A0090','Dot','hamster','Russe',1,0,'U0010'),

-- CAMÉLÉONS (5)
('A0091','Kameleon','caméléon','Panthère',3,1,'U0001'),
('A0092','Chroma','caméléon','Voilé',4,1,'U0002'),
('A0093','Iris','caméléon','Panthère',2,1,'U0003'),
('A0094','NeoCam','caméléon','Voilé',3,1,'U0004'),
('A0095','Color','caméléon','Panthère',5,1,'U0005'),

-- LÉZARDS (5)
('A0096','Spike','lézard','Gecko',2,1,'U0006'),
('A0097','Draco','lézard','Iguane',4,5,'U0007'),
('A0098','Slink','lézard','Anolis',3,1,'U0008'),
('A0099','Scales','lézard','Gecko',2,1,'U0009'),
('A0100','Viper','lézard','Iguane',5,6,'U0010');
